...
Subst readSubstitution(const tinyxml2::XMLElement *dom,
  ...
  if (nullptr == dom) throw SubstReaderException("Null dom element.");
  ...
  if (0 == strcmp(tagName, "Nary_Sub")) {
    ...
    if (0 == strcmp(op, "||"))
      ...
      throw SubstReaderException("Unknown nary substitution operator '" +
                                 std::string(op) + "'.");
  } else {
  ...
  switch (kind) {
    case Subst::SKind::Block:
      return Subst::makeBlock(
          readSubstitution(dom->FirstChildElement(), typeInfos));
      ...
      if (0 == strcmp(tagName, "PRE_Sub")) {
        ...
        if (guard == nullptr)
          throw SubstReaderException(
              "Missing child 'Precondition' in PRE_Sub element.");
      } else {
        guard = dom->FirstChildElement("Guard");
        if (guard == nullptr)
          throw SubstReaderException(
              "Missing child 'Guard' in Assert_Sub element.");
      }
      const tinyxml2::XMLElement *body = dom->FirstChildElement("Body");
      if (body == nullptr)
        throw SubstReaderException(
            "Missing child 'Body' in Assert_Sub or PRE_Sub element.");
    ...
    case Subst::SKind::IfThenElse: {
      const tinyxml2::XMLElement *condition =
          dom->FirstChildElement("Condition");
      if (condition == nullptr)
        throw SubstReaderException(
            "Missing child 'Condition' in 'If_Sub' element.");
    ...
    case Subst::SKind::SimpleAssignment: {
      ...
      if (vars == nullptr)
        throw SubstReaderException(
            "Missing child 'Variables' in 'Simple_Assignement_Sub' element.");
      ...
      if (values == nullptr)
        throw SubstReaderException(
            "Missing child 'Values' in 'Simple_Assignement_Sub' element.");
    ...
    case Subst::SKind::CaseElse: {
      ...
      if (value == nullptr)
        throw SubstReaderException(
            "Missing child 'Value' in 'Case_Sub' element.");
      const tinyxml2::XMLElement *choices = dom->FirstChildElement("Choices");
      if (choices == nullptr)
        throw SubstReaderException(
            "Missing child 'Choices' in 'Case_Sub' element.");
      std::vector<Subst::CaseChoice> vec;
      for (const tinyxml2::XMLElement *ce =
               choices->FirstChildElement("Choice");
           ce != nullptr; ce = ce->NextSiblingElement("Choice")) {
        Subst::CaseChoice ch;
        for (const tinyxml2::XMLElement *v = ce->FirstChildElement("Value");
             v != nullptr; v = v->NextSiblingElement("Value")) {
          ch.values.push_back(
              readExpression(v->FirstChildElement(), typeInfos));
        }
        if (ch.values.empty())
          throw SubstReaderException(
              "Missing child 'Value' in 'Choice' element.");
        const tinyxml2::XMLElement *then = ce->FirstChildElement("Then");
        if (then == nullptr)
          throw SubstReaderException(
              "Missing child 'Then' in 'Choice' element.");
        ch.body = readSubstitution(then->FirstChildElement(), typeInfos);
        vec.push_back(std::move(ch));
      }
      const tinyxml2::XMLElement *els = dom->FirstChildElement("Else");
      if (els == nullptr)
        return Subst::makeCase(
            readExpression(value->FirstChildElement(), typeInfos),
            std::move(vec));
      else {
        return Subst::makeCaseElse(
            readExpression(value->FirstChildElement(), typeInfos),
            std::move(vec),
            readSubstitution(els->FirstChildElement(), typeInfos));
      }
    ...
    case Subst::SKind::Any: {
      ...
      if (pred == nullptr)
        throw SubstReaderException(
            "Missing child 'Pred' in 'ANY_Sub' element.");
      const tinyxml2::XMLElement *then = dom->FirstChildElement("Then");
      if (then == nullptr)
        throw SubstReaderException(
            "Missing child 'Then' in 'ANY_Sub' element.");
      const tinyxml2::XMLElement *fc = then->FirstChildElement();
      return Subst::makeAny(vec,
    ...
    case Subst::SKind::Witness: {
      ...
      if (wt == nullptr)
        throw SubstReaderException(
            "Missing child 'Witnesses' in 'Witness' element.");
      ...
      if (0 == strcmp(wt_child->Name(), "Nary_Pred")) {
        if (0 != strcmp(wt_child->Attribute("op"), "&"))
          throw SubstReaderException(
              "Expected Nary_Pred with attribute op '&'.");
        for (const tinyxml2::XMLElement *ce =
                 wt_child->FirstChildElement("Exp_Comparison");
             ce != nullptr; ce = ce->NextSiblingElement("Exp_Comparison")) {
          if (0 != strcmp(ce->Attribute("op"), "="))
            throw SubstReaderException(
                "Expected Exp_Comparison with attribute op '='.");
          ...
          std::pair<std::string, Expr> pair = {id->Attribute("value"),
                                               readExpression(expr, typeInfos)};
        ...
        throw SubstReaderException(
            "Nary_Pred or Exp_Comparison element expected.");
      }
      const tinyxml2::XMLElement *body = dom->FirstChildElement("Body");
      if (body == nullptr)
        throw SubstReaderException(
            "Missing child 'Body' in 'Witness' element.");
    ...
    case Subst::SKind::OperationCall: {
      ...
      if (name == nullptr)
        throw SubstReaderException(
            "Missing child 'Name' in 'Operation_Call' element.");
      const tinyxml2::XMLElement *id = name->FirstChildElement("Id");
      if (id == nullptr)
        throw SubstReaderException("Missing child 'Id' in 'Name' element.");
      if (nullptr == id->Attribute("value"))
        throw SubstReaderException(
            "Missing attribute 'value' in 'Id' element.");

      // Inputs (Effective)
      std::vector<Expr> v_input;
      const tinyxml2::XMLElement *input =
          dom->FirstChildElement("Input_Parameters");
      if (input != nullptr) {
      ...
      const tinyxml2::XMLElement *output =
          dom->FirstChildElement("Output_Parameters");
      if (output != nullptr) {
      ...
      const tinyxml2::XMLElement *operation =
          dom->FirstChildElement("Operation");
      if (operation == nullptr)
        throw SubstReaderException(
            "Missing child 'Operation' in 'Operation_Call' element.");
      if (nullptr == operation->Attribute("name"))
        throw SubstReaderException(
            "Missing attribute 'name' in 'Operation' element.");

      // Outputs (Formal)
      std::vector<TypedVar> op_outputs;
      const tinyxml2::XMLElement *op_out_params =
          operation->FirstChildElement("Output_Parameters");
      if (op_out_params != nullptr) {
        for (const tinyxml2::XMLElement *ce =
                 op_out_params->FirstChildElement("Id");
             ce != nullptr; ce = ce->NextSiblingElement("Id")) {
      ...
      const tinyxml2::XMLElement *op_in_params =
          operation->FirstChildElement("Input_Parameters");
      if (op_in_params != nullptr) {
        for (const tinyxml2::XMLElement *ce =
                 op_in_params->FirstChildElement("Id");
             ce != nullptr; ce = ce->NextSiblingElement("Id")) {
      ...
      if (v_input.size() != op_inputs.size())
        throw SubstReaderException(
            "Wrong number of input parameters in call to operation " +
      ...
      if (v_output.size() != op_outputs.size())
        throw SubstReaderException(
            "Wrong number of output parameters in call to operation " +
            std::string(id->Attribute("value")) +
            " (Formal: " + std::to_string(op_outputs.size()) + ", " +
            "Effective: " + std::to_string(v_output.size()) + ")");

      // Precondition
      const tinyxml2::XMLElement *op_pre =
          operation->FirstChildElement("Precondition");
      Pred pre = op_pre == nullptr
                     ? Pred::makeTrue()
                     : readPredicate(op_pre->FirstChildElement(), typeInfos);

      // Body
      const tinyxml2::XMLElement *op_body =
          operation->FirstChildElement("Body");
      if (op_body == nullptr)
        throw SubstReaderException("Missing body in call to operation " +
                                   std::string(id->Attribute("value")));

      return Subst::makeOpCall(
          id->Attribute("value"), std::move(v_input), v_output, op_inputs,
          op_outputs, std::move(pre),
    ...
    case Subst::SKind::While: {
      ...
      if (cond == nullptr)
        throw SubstReaderException(
            "Missing child 'Condition' in 'While' element.");
      const tinyxml2::XMLElement *body = dom->FirstChildElement("Body");
      if (body == nullptr)
      ...
      if (inv == nullptr)
        throw SubstReaderException(
            "Missing child 'Invariant' in 'While' element.");
      const tinyxml2::XMLElement *var = dom->FirstChildElement("Variant");
      if (var == nullptr)
        throw SubstReaderException(
            "Missing child 'Variant' in 'While' element.");
  ...
  throw SubstReaderException("Unreachable code executed");
}
}  // namespace Xml
